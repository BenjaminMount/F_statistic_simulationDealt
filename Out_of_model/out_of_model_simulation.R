data <- read.table("F:/hust/Doct/Thesis2/data_code/F2_final.txt", header = F, sep = "\t")
data <- data[,-6]
...
# Find the maximum and minimum values in the first changing interval
...
#Fst
data_st <- read.table("F:/hust/Doct/Thesis2/data_code/Fst_final.txt", header = F, sep = "\t")
data_st <- data_st[,-8]
...
# find maximum and minimum values in the first interval
